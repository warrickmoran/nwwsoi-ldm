"""
Some basic things that all the ingestors need and use.  For 
example, the basic jabber connection client is here.
"""
...
import io as StringIO # https://docs.python.org/3/library/io.html
...
def make_jabber_client(resource_prefix):
    ...
    reactor.connectTCP(settings.get('pywwa_jabber_host', 'nwschat-openfire'), 5222, 
                       factory)
...
class JabberClient:
    ...
    def sendMessage(self, body, html, xtra):
        ...
        # we always have body content to add!
