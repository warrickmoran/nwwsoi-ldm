...
def main(argv=None):
    ...
    try:
        ...
        parser.add_option("-d", "--ldmcmd", dest="ldmcmd", help="location of pqinsert command")
        ...
        xmpp = bot.MUCBot(opts.jid, opts.password, opts.room, opts.nick,OI_URL, q, opts.ldmcmd)
